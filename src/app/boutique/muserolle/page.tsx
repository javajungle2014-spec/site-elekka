...
export default function MuserollePage() {
  return (
    <PieceDetail piece={{
      ...
      priceEUR: 27.99,
      models: [
        { key: "simple",     label: "Simple",         desc: "Muserolle française classique, fermeture standard",                    priceEUR: 27.99 },
        { key: "rembourree", label: "Rembourrée",     desc: "2,5 à 3 cm d'épaisseur — protège et adoucit le contact",              priceEUR: 32.99 },
        { key: "triple",     label: "Triple attache", desc: "Interchangeable : épaisse, ovale, rectangulaire — 3 muserolles en 1",  priceEUR: 37.99 },
      ],
      colours: [
