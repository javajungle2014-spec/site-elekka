...
export default function MuserollePage() {
  return (
    <PieceDetail piece={{
      ...
      priceEUR: 27.99,
      models: [
        { key: "simple", label: "Simple", desc: "Muserolle française classique, fermeture standard — Essentiel", priceEUR: 27.99, images: {
        ...
        { key: "rembourree", label: "Rembourrée", desc: "2,5 à 3 cm d'épaisseur — protège et adoucit le contact — Signature", priceEUR: 54.25, images: {
        ...
        { key: "triple", label: "Triple attache", desc: "Interchangeable : épaisse, ovale, rectangulaire — Fusion", priceEUR: 54.25, images: {
